# AirBnB Clone [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/asdacosta/AirBnB_clone/blob/master/LICENSE) [![Build Status](https://travis-ci.org/asdacosta/AirBnB_clone.svg?branch=master)](https://travis-ci.org/asdacosta/AirBnB_clone)
...
OAOAOAOA(hbnb) User.create()
e6ee5344-04ef-454d-84e4-ba6fc613f1b4
OAOAOAOAOAOAOAOAOAOAOAOAOA(hbnb) User.all()
...
OAOAOAOAOA(hbnb) User.show()
** instance id missing **
OAOAOAOA(hbnb) User.show(e6ee5344-04ef-454d-84e4-ba6fc613f1b4)
[User] (e6ee5344-04ef-454d-84e4-ba6fc613f1b4) {'id': 'e6ee5344-04ef-454d-84e4-ba6fc613f1b4', 'updated_at': datetime.datetime(2019, 11, 13, 17, 14, 1, 963404), 'created_at': datetime.datetime(2019, 11, 13, 17, 14, 1, 963373)}
OAOAOAOA(hbnb) User.update("e6ee5344-04ef-454d-84e4-ba6fc613f1b4", "name", "Betty")
OAOA['User', '"e6ee5344-04ef-454d-84e4-ba6fc613f1b4"', '"name"', '"Betty"']
(hbnb) User.all()
OAOA['[User] (e6ee5344-04ef-454d-84e4-ba6fc613f1b4) {\'"name"\': \'"Betty"\', \'id\': \'e6ee5344-04ef-454d-84e4-ba6fc613f1b4\', \'updated_at\': datetime.datetime(2019, 11, 13, 17, 14, 1, 963404), \'created_at\': datetime.datetime(2019, 11, 13, 17, 14, 1, 963373)}']
OAOA(hbnb) User.destroy(e6ee5344-04ef-454d-84e4-ba6fc613f1b4)
OA(hbnb) User.all()
[]
(hbnb) quit
OAOAOA➜  AirBnB_clone git:(feature) ✗

OAOAOAOAOAOA```

OAOA## Built with :gear:
python3 (3.4.3)
